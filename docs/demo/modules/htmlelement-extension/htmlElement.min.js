...
document.addStyleSheets = function (arrStylessUrl) {
  var media = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "all";
...
HTMLSelectElement.prototype.val = function () {
  if (arguments.length == 0) {
    ...
    try {
      for (var _iterator5 = this.selectedOptions[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
